...
public interface Sendable {
  /**
   * Gets the name of this {@link edu.wpi.first.wpilibj.Sendable} object.
   *
   * @return Name
  ...
  /**
   * Sets the name of this {@link edu.wpi.first.wpilibj.Sendable} object.
   *
   * @param name name
  ...
  /**
   * Sets both the subsystem name and device name of this {@link edu.wpi.first.wpilibj.Sendable} object.
   *
  ...
  /**
   * Gets the subsystem name of this {@link edu.wpi.first.wpilibj.Sendable} object.
   *
  ...
  /**
   * Sets the subsystem name of this {@link edu.wpi.first.wpilibj.Sendable} object.
   *
   * @param subsystem subsystem name
  ...
  /**
   * Initializes this {@link edu.wpi.first.wpilibj.Sendable} object.
   *
